...
/*   Updated: 2024/10/08 15:17:48 by rbutzke          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	RobotomyRequestForm::howToRun() const {
	...
	{
		Debug::msg(1, RED ITALI SUBLI BOLD "Robotomy failed.\n" RESET);
		Debug::msg(1, RED ITALI SUBLI BOLD "robotization has a 50\% chance of success.\n" RESET);
	}
...
RobotomyRequestForm::RobotomyRequestForm():
AForm("RobotomyRequestForm", SIGN_ROBOT, EXEC_ROBOT),
